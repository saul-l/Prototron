...
public class CustomPostProcessPass : ScriptableRenderPass
{
    ...
    public override void Execute(ScriptableRenderContext context, ref RenderingData renderingData)
    {
        ...
        CustomPostProcessingMaterials materials = CustomPostProcessingMaterials.Instance;
        if (materials == null)
        {
        ...
        //---Custom effect here---
        CustomEffectComponent customEffect = stack.GetComponent<CustomEffectComponent>();
        // Only process if the effect is active
        if (customEffect.IsActive())
        {
            Material material = materials.customEffect;
            ...
            material.SetTexture(Shader.PropertyToID("_FakeLightTexture"), customEffect.fakeLightTexture.value);
